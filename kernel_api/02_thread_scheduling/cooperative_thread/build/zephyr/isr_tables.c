...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[86] = {
	...
	{(const void *)0x8003ee6, (ISR)0x8000e6d}, /* 6 */
	{(const void *)0x8003ee4, (ISR)0x8000e6d}, /* 7 */
	{(const void *)0x8003ee2, (ISR)0x8000e6d}, /* 8 */
	{(const void *)0x8003ee0, (ISR)0x8000e6d}, /* 9 */
	{(const void *)0x8003ede, (ISR)0x8000e6d}, /* 10 */
	...
	{(const void *)0x8003edc, (ISR)0x8000e6d}, /* 23 */
	...
	{(const void *)0x8003eda, (ISR)0x8000e6d}, /* 40 */
