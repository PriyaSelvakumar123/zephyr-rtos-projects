...
const uintptr_t __irq_vector_table _irq_vector_table[85] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[85] = {
	...
	{(const void *)0x8003d7f, (ISR)0x8000e31}, /* 6 */
	{(const void *)0x8003d7d, (ISR)0x8000e31}, /* 7 */
	{(const void *)0x8003d7b, (ISR)0x8000e31}, /* 8 */
	{(const void *)0x8003d79, (ISR)0x8000e31}, /* 9 */
	{(const void *)0x8003d77, (ISR)0x8000e31}, /* 10 */
	...
	{(const void *)0x8003d75, (ISR)0x8000e31}, /* 23 */
	...
	{(const void *)0x8003d73, (ISR)0x8000e31}, /* 40 */
